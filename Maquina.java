...
public class Maquina {
    public static void main(String[] args) {
        ...
        Instrucao instrucao1ByteExemplo = new Instrucao1Byte("11000100");
        // Chamando o método para imprimir os detalhes da instrução de 1 byte
        instrucao1ByteExemplo.imprimirDetalhesInstrucao();
        ...
        Instrucao instrucao2BytesExemplo = new Instrucao2Bytes("1011010000010000");
        // Chamando o método para imprimir os detalhes da instrução de 2 bytes
        instrucao2BytesExemplo.imprimirDetalhesInstrucao();

        //Exemplo de Instrução de 3 Bytes
        //Instrução TD OUTPUT = E32011, Opcode E0
        Instrucao instrucao3BytesExemplo = new Instrucao3Bytes("111000110010000000010001");

        // Chamando o método para imprimir os detalhes da instrução de 3 bytes
        instrucao3BytesExemplo.imprimirDetalhesInstrucao();
        ...
        Instrucao instrucao4BytesExemplo = new Instrucao4Bytes("00000011000100001100001100000011");

        // Chamando o método para imprimir os detalhes da instrução de 4 bytes
        instrucao4BytesExemplo.imprimirDetalhesInstrucao();
    }
