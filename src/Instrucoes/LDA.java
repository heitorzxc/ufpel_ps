...
public class LDA extends Instrucao {
    ...
    public void executar(Endereco instrucao, BancoRegistradores registradores, Memoria memoria) {
        ...
        // System.out.println("A intruçao é LDA imediato, que insere o valor inteiro do
        // binário "
        // + endereco.getPalavra().getEnderecoBinario() + " no Registrador A.");
        ...
        // System.out.println("A intruçao é LDA direto, que insere o valor que está no
        // endereço "
        // + endereco.getPalavra().getEnderecoBinario() + " no Registrador A.");
