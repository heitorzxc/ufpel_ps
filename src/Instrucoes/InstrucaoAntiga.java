...
// if (numBin.length() == 8 || numBin.length() == 16 || numBin.length() == 24 ||
// numBin.length() == 32) {
// interpretarInstrucao();
// } else {
// System.out.println("Número binário inválido. Deve ter 8, 16, 24 ou 32
// bits.");
// }
// }
...
// this.numBin = numBin;
// interpretarInstrucao(); // Chama a interpretação toda vez que o numBin é
// atualizado
// }
